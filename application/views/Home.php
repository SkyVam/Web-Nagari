...
<head>
<title>Home-Nagari Parik Panjang</title>
  <meta charset="utf-8">
  ...
  <header class="masthead">
    ...
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in" style="  text-shadow:
    -1px -1px 0 #000,
     0   -1px 0 #000,
     1px -1px 0 #000,
     1px  0   0 #000,
     ...
     0    1px 0 #000,
    -1px  1px 0 #000,
    -1px  0   0 #000;">Selamat Datang</div>
        <div class="intro-heading text-uppercase" style="  text-shadow:
    -1px -1px 0 #000,
     0   -1px 0 #000,
     1px -1px 0 #000,
     1px  0   0 #000,
     ...
     0    1px 0 #000,
    -1px  1px 0 #000,
    -1px  0   0 #000;">Nagari Parik Panjang</div>
      <h5 style="text-align: center; color: white;  text-shadow:
    -1px -1px 0 #000,
     0   -1px 0 #000,
     1px -1px 0 #000,
     1px  0   0 #000,
     ...
     0    1px 0 #000,
    -1px  1px 0 #000,
    -1px  0   0 #000;">-Mengabdi untuk Melayani-
                       </h5>
...
<br><br>Selamat datang di website Nagari Parik Panjang. Situs ini dibuat sebagai wadah informasi seputar Nagari Parik Panjang. Semoga apa yang ada dalam site ini dapat bermanfaat bagi masyarakat desa pada khususnya dan masyarakat luar pada umumnya. 
